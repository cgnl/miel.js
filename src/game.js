...
class MulleGame extends Phaser.Game {
  constructor() {
    ...
    this.mulle.loadBoatAssets = function (loader) {
      ...
      // NOTE: zee_intro pack is NOT loaded here — its sprite atlases use short
      // numeric frame names that collide with car/yard atlases. The zee_intro
      // scene loads its own pack when entered. Sound effects like 01e003v0
      // are only available after visiting zee_intro.
